...
function isSameDate(firstDate, secondDate) {
    return (0, _moment2.default)(firstDate, 'DD/MM/YYYY').diff((0, _moment2.default)(secondDate, 'DD/MM/YYYY'), 'days', false) === 0;
}

function isDisabled(minDate, currentDate, maxDate) {
    var min = (0, _moment2.default)((0, _moment2.default)(minDate).format('DD/MM/YYYY'), 'DD/MM/YYYY');
    var max = (0, _moment2.default)((0, _moment2.default)(maxDate).format('DD/MM/YYYY'), 'DD/MM/YYYY');
    var current = (0, _moment2.default)((0, _moment2.default)(currentDate).format('DD/MM/YYYY'), 'DD/MM/YYYY');
...
exports.RenderDays = exports.RenderSingleDay = exports.RenderDayHeader = exports.RenderMonthHeader = exports.RenderMonthCard = exports.RenderCalendarYear = undefined;
...
var ScrollCalendar = function (_Component) {
  ...
  function ScrollCalendar(props) {
    _classCallCheck(this, ScrollCalendar);
...
var RenderCalendarYear = exports.RenderCalendarYear = function RenderCalendarYear(props) {
  var minDate = props.minDate,
      maxDate = props.maxDate;

  var totalMonth = Math.round(maxDate.diff(minDate, 'months', true)) + 1;
  var now = (0, _moment2.default)(minDate, 'DD/MMM/YYYY');
  var elements = [];
  for (var i = 0; i < totalMonth; i++) {
    elements.push(_react2.default.createElement(RenderMonthCard, _extends({ key: i, currentMonth: now.clone() }, props)));
    now = now.add(1, 'M');
  }
